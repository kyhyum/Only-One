...
{
    public OverwriteSaveData(bool _sound, bool _backgroundsound, int[] _passiveskill, int[] _activeskill, int _money)
    {
        sound = _sound;
...
public class UserDataManager : MonoBehaviour
{
    ...
    {
        OverwriteSaveData saveData = new OverwriteSaveData(sound, backgroundsound, passiveskill, activeskill, money);
